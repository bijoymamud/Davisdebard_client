...
const faqDataGeneral = [
  { question: "How do I use the Chat screen?", answer: "Select a Chat tool, such as ChatGPT. Type a question. Click the airplane icon." },
  { question: "How can I get a different tool to respond to the same question?", answer: "After having already entered with one tool, click another. It will answer the same question. It will know the history of this chat." },
  { question: "When I have a series of questions, will the other tools be brought up to date with the level of detail when I switch from one to another?", answer: "Yes." },
  { question: "A paid subscription to ChatGPT 4.0 will generate graphics. Why won’t this?", answer: "Graphics are available in a different subsystem. Currently, graphics are not supported, but we plan to offer this in future versions." },
  { question: "I want to use an AI tool that is not listed here. Can I?", answer: "Each tool needs to be programmed to work. In future versions, we may expand our offerings, based on your suggestions." },
  { question: "I made a query a long time ago, but don’t see it listed in my query history. Why?", answer: "Queries are retained for a 7-day period. In future versions, we may expand this for premium-level users." },
  { question: "I want to resume a query that I started previously. How can I do that?", answer: "Currently, query histories are view-only. You can copy questions and start a new chat with them." }
];

const faqDataSubscription = [
  { question: "Can I get a free version?", answer: "Both monthly and annual subscription methods are free for the first seven (7) days." },
  { question: "Can I cancel at any time?", answer: "Yes. Within the first seven days, you may cancel at no charge. After that, there are generally no refunds. Canceling will only stop auto-renew." },
  { question: "Can I get my money back?", answer: "After the first seven days, generally, no. Contact support if you have an issue." },
  { question: "How do I cancel my subscription?", answer: "Click the hamburger icon. Click Subscription. Click Unsubscribe. Your subscription will then not auto-renew." },
  { question: "Can I upgrade my plan from monthly to annual?", answer: "Yes. Click the hamburger icon. Click subscriptions. Click Upgrade to sign up for the annual plan." },
  { question: "Can I downgrade my plan from annual to monthly?", answer: "Yes. Click the hamburger icon. Click subscriptions. Click Downgrade to sign up for the monthly plan." }
];
...
const Faq = () => {
  ...
  const filteredFaqData = filter === "General" ? faqDataGeneral : faqDataSubscription;
