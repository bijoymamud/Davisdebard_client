...
// import { AiOutlineFileSync, AiTwotoneDiff } from "react-icons/ai";
...
//   // Handle Floating Button Click (Redirect to Home)
//   const handleGoHome = () => {
//     navigate("/");
//   };
...
//                     </button>
//                     <button onClick={() => handleResumeChat(chat.id)} className="flex items-center px-2 py-1 hover:bg-[#734a8d] rounded-sm">
//                       <AiOutlineFileSync  className="text-lg text-white" />
//                       <span className="ml-2 text-sm font-medium">Resume</span>
//                     </button>
//                   </ul>
//                 </div>
...
//         className="fixed flex items-center text-center md:px-5 top-1 right-6 bg-[#48225f] hover:bg-[#3a1a4e] text-white p-2 rounded-full shadow-lg transition-all duration-200"
//       >
//         <IoIosArrowBack className="text-xl" />
//         <h1 className="uppercase text-xs md:text-base pr-2">Return</h1>
//       </button>
//     </div>
//   );
// }
