...
<div className="flex flex-col md:grid md:grid-cols-4 gap-5">
  ...
  {/* Large Device Design: Unchanged */}
        ...
        {/* <div className="mb-6 md:max-w-7xl mx-auto h-full flex flex-col mt-20 space-y-4 md:p-4 p-1">
...
{/* <div
  className="mb-6 md:max-w-7xl mx-auto h-[60vh]  flex flex-col md:mt-14 space-y-4 md:p-4 p-1 overflow-y-auto"
  style={{ scrollbarWidth: "thin", scrollbarColor: "#9ECA2E transparent" }} // Optional for better scroll styling
>
  {chatMessages.map((msg, index) => (
    <div
      key={index}
    ...
    >
      ...
      <div className="flex flex-col">
        <div
          className={`px-4 py-2 rounded-lg shadow-sm w-10/12 w-full ${
            msg.role === "user"
              ? "bg-gray-500 text-right text-white"
              : "bg-gray-100 text-left"
          }`}
        >
          {msg.content}
...
<div
      ...
      className="mb-6 md:max-w-7xl mx-auto h-[60vh] flex flex-col md:mt-14 space-y-4 md:p-4 p-1 overflow-y-auto shadow"
      style={{
        scrollbarWidth: "thin",
...
//         setChatMessages((prev) => [...newMessages, ...prev]); // Prepend older messages
//         setPage((prev) => prev + 1);
//       }
//       setHasMore(response?.data?.hasMore ?? false); // Update hasMore based on API response
//     } catch (error) {
...
//         <div
//           ref={chatContainerRef}
//           className="mb-6 md:max-w-7xl mx-auto h-[60vh] overflow-y-auto flex flex-col-reverse space-y-4 space-y-reverse md:p-4 p-1"
//         >
//           {chatMessages.map((msg, index) => (
//             <div
//               key={index}
